...
1. *N^2.*
2. *No. Yes, Rows must be equal to Columns.*
...
1. *No.*
2. *No.*
3. *when there are some items outside of the sort list, it exists a cycle. Print all the items and compare with the sort list.If there exists some extro itmes, a cycle is there.*
