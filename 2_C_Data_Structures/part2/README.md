...
*My answer is ...*
 "first in last out". Stack is allocated by the system automatically, so it is fast. The use of a stack is like going to a restaurant, where we order (send out a request), pay, and eat (use), and then leave without paying attention to the preparation work such as cutting vegetables and washing vegetables, and the cleaning work such as washing dishes and pans. The advantage is that it is fast and easy.
