...
*For the strcmp function, if strings are equal,then  strcmp(*s1,*s2) == 0; else it is non-zero. if "strcmp(*s1,*s2) < 0", it means that s1 is ahead to s2 in the alphabetical order.*
